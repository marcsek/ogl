...
CIMGUI_API void SeparatorText(const char* label);                                                  // currently: formatted text with an horizontal line
...
CIMGUI_API void Image(ImTextureID user_texture_id, ImVec2 image_size);                                  // Implied uv0 = ImVec2(0, 0), uv1 = ImVec2(1, 1), tint_col = ImVec4(1, 1, 1, 1), border_col = ImVec4(0, 0, 0, 0)
CIMGUI_API void ImageEx(ImTextureID user_texture_id, ImVec2 image_size, ImVec2 uv0 /* = ImVec2(0, 0) */, ImVec2 uv1 /* = ImVec2(1, 1) */, ImVec4 tint_col /* = ImVec4(1, 1, 1, 1) */, ImVec4 border_col /* = ImVec4(0, 0, 0, 0) */);
...
// Focus, Activation
CIMGUI_API void SetItemDefaultFocus(void);                           // make last item the default focused item of of a newly appearing window.
...
CIMGUI_API const char* GetKeyName(ImGuiKey key);                                                 // [DEBUG] returns English name of the key. Those names a provided for debugging purpose and are not meant to be saved persistently not compared.

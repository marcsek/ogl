...
// backends!
CIMGUI_IMPL_API bool cImGui_ImplGlfw_InitForOpenGL(GLFWwindow *window,
                                                   bool install_callbacks);
CIMGUI_IMPL_API bool cImGui_ImplGlfw_InitForVulkan(GLFWwindow *window,
                                                   bool install_callbacks);
CIMGUI_IMPL_API bool cImGui_ImplGlfw_InitForOther(GLFWwindow *window,
                                                  bool install_callbacks);
...
cImGui_ImplGlfw_InstallEmscriptenCallbacks(GLFWwindow *window,
...
CIMGUI_IMPL_API void
cImGui_ImplGlfw_SetCallbacksChainForAllWindows(bool chain_for_all_windows);

// GLFW callbacks (individual callbacks to call yourself if you didn't install
// callbacks)
CIMGUI_IMPL_API void
cImGui_ImplGlfw_WindowFocusCallback(GLFWwindow *window,
                                    int focused); // Since 1.84
CIMGUI_IMPL_API void
cImGui_ImplGlfw_CursorEnterCallback(GLFWwindow *window,
                                    int entered); // Since 1.84
CIMGUI_IMPL_API void cImGui_ImplGlfw_CursorPosCallback(GLFWwindow *window,
                                                       double x,
                                                       double y); // Since 1.87
CIMGUI_IMPL_API void cImGui_ImplGlfw_MouseButtonCallback(GLFWwindow *window,
                                                         int button, int action,
                                                         int mods);
CIMGUI_IMPL_API void cImGui_ImplGlfw_ScrollCallback(GLFWwindow *window,
                                                    double xoffset,
                                                    double yoffset);
CIMGUI_IMPL_API void cImGui_ImplGlfw_KeyCallback(GLFWwindow *window, int key,
                                                 int scancode, int action,
                                                 int mods);
CIMGUI_IMPL_API void cImGui_ImplGlfw_CharCallback(GLFWwindow *window,
                                                  unsigned int c);
CIMGUI_IMPL_API void cImGui_ImplGlfw_MonitorCallback(GLFWmonitor *monitor,
                                                     int event);
